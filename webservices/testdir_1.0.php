...
$inputT = array();
$inputT['testdir_madcat_file'] = array('name'=>'testdir_madcat_file', 'type'=>'xsd:string');
$inputT['testdir_image_file'] = array('name'=>'testdir_image_file', 'type'=>'xsd:string');


$outputT = array();
$outputT['testdir_output'] = array('name'=>'testdir_output', 'type'=>'xsd:string');
...
function callback($input) {
	 ...
	 */
	$inputMadcat = $input['testdir_madcat_file'];
	$inputImage = $input['testdir_image_file'];
    ...
    $result=array('testdir_output' => $resultFile);
