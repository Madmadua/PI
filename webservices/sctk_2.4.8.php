 ...
 */
$inputT = array();
$inputT['sctk_reference_file'] = array('name'=>'sctk_reference_file', 'type'=>'xsd:string');
$inputT['sctk_hypothesis_file'] = array('name'=>'sctk_hypothesis_file', 'type'=>'xsd:string');
 ...
 * @var $outputT
 */
$outputT['sctk_result'] = array('name'=>'sctk_result', 'type'=>'xsd:string');
$outputT['sctk_summary'] = array('name'=>'sctk_summary', 'type'=>'xsd:string');
//== STOP EDITABLE ZONE
...
function callback($input) {
	 ...
	 */
	$inputReference = $input['sctk_reference_file'];
	$inputHypothesis = $input['sctk_hypothesis_file'];
    ...
    //Running tercom
    	...
    	$execString = '/home/dae/WebServices/sctk-2.4.8/sclite -r '.$referenceFile.' -h '.$hypothesisFile.' -i sp -e utf-8 -D -o rsum \"sgml\" -n output -O '.$localdir.' 1>log.txt 2>log.txt';
    //== STOP EDITABLE ZONE
    ...
    $result=array('sctk_result' => 'http://localhost/'.substr($localdir,9).'/output.sgml','sctk_summary' => 'http://localhost/'.substr($localdir,9).'/output.raw');
