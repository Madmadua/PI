 ...
 */
$inputT = array();
$inputT['source-url'] = array('name'=>'source-url', 'type'=>'xsd:string');
...
function callback($input) {
    ...
    $execString = 'wget '.$inputSource.' -q -O '.$sourceFile;
    ...
    $execString = 'perl bin/mteval-v13a.pl -r '.$referenceFile.' -s '.$sourceFile.' -t '.$hypothesisFile.' -c -d 2 -b > '.$localdir.'/output.txt';
    //== STOP EDITABLE ZONE
    ...
    $result=array('result-url' => 'http://localhost/'.substr($localdir,9).'/output.txt');
    //== STOP EDITABLE ZONE
