...
$input=array('source-url' => 'http://localhost/openhart/db/ref.src','reference-url' => 'http://localhost/openhart/db/ref.sgml','hypothesis-url' => 'http://localhost/openhart/db/hyp.sgml');
//== STOP EDITABLE ZONE
