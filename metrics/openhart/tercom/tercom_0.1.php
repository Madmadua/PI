...
function callback($input) {
	...
	$execString = 'java -jar bin/tercom.7.25.jar -s -N -r '.$referenceFile.' -h '.$hypothesisFile.' -n '.$localdir.'/output -o sum 1>/dev/null';
	//== STOP EDITABLE ZONE
    ...
    $result=array('result-url' => 'http://localhost/'.substr($localdir,9).'/output.sum');
